## -- Uniwersalne zwroty --
from modules.locales.en_US import errorCooldown
...
jobList = {
    ...
    63: "User {user} pracował jako recepcjonista hotelowy i zarobił {earnings} :coin:.",
    64: "User {user} pracował jako ratownik na basenie i zarobił {earnings} :coin:.",
